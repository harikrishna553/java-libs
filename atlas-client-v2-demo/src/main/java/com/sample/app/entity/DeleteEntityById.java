...
public class DeleteEntityById {

	private static final String TYPE_NAME = "DemoType18";
	...
	private static String createEntity(AtlasClientV2 atlasClient) throws AtlasServiceException {
		...
		atlasEntity.setAttribute("qualifiedName", "DeleteEntityById_DEMO1");
		atlasEntity.setAttribute("name", "DeleteEntityById_DEMO1");
	...
	public static void main(String[] args) throws AtlasServiceException {
		...
		System.out.println("Deleting the entity with guid : " + guid);
