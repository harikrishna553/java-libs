...
public class CsvReaderQuotedAndCommentsDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		CsvReader csvReader = new CsvReader(resourceFilePath("empsQuotedAndCommentsDemo.csv"), executionEnvironment)
				.ignoreFirstLine().ignoreComments("$").parseQuotedStrings('"');
