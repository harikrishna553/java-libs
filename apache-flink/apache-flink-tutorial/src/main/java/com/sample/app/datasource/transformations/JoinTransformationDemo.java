...
public class JoinTransformationDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Tuple2<Customer, Order>> resultDataSet = customersDataSet.join(ordersDataSet)
		...
		.forEach(tuple2 -> {
			...
			Order order = tuple2.f1;
			
			System.out.println(customer.getId() + "," +customer.getName() + "," + customer.getCountry() + "," + order.getId() + ","+order.getOrderDate());
		});
