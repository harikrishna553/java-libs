...
public class GetDataSourceFromCSVFile {
	...
	public static void main(String[] args) throws Exception {
		...
		final CsvReader csvReader = executionEnvironment.readCsvFile(resourceFilePath("emps.csv"));

		DataSource<Tuple4<Integer, String, Integer, String>> dataSource = csvReader.ignoreFirstLine()
