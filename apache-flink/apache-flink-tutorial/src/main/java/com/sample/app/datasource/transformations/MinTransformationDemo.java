...
import com.sample.app.datasource.transformations.MaxTransformationDemo.EmployeeCitySplitter;

public class MinTransformationDemo {
	...
	public static String resourceFilePath(String resourceFile) {
		ClassLoader classLoader = MinTransformationDemo.class.getClassLoader();
