...
public class CsvReaderDelimiterDemo {
	...
	public static void main(String[] args) throws Exception {
		...
		CsvReader csvReader = new CsvReader(resourceFilePath("empsDelimiterDemo.csv"), executionEnvironment)
				.ignoreFirstLine().fieldDelimiter(":").lineDelimiter("|");
