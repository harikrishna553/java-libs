...
public class InMemoryRagWithFilter {
	...
	public static void main(String[] args) {
		...
		EmbeddingStoreContentRetriever embeddingStoreContentRetriever = EmbeddingStoreContentRetriever.builder().embeddingModel(new BgeSmallEnV15QuantizedEmbeddingModel())
				.embeddingStore(embeddingStore).filter(object -> {
