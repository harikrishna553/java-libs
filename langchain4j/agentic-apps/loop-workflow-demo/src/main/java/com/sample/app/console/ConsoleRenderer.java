...
public final class ConsoleRenderer {
  ...
  private static final AttributedStyle CODE_SPAN =
      AttributedStyle.DEFAULT.foreground(208).background(236); // orange
  // on
  // dark
  ...
  private static final AttributedStyle FINAL_RESULT =
      bold(AttributedStyle.GREEN | AttributedStyle.BRIGHT);
  ...
  public static void printBanner() {
    ...
    String title = "✨   Story Teller Workflow   ✨";
    System.out.println();
  ...
  public static void agent(String text) {
    System.out.println();
    System.out.println(s(AGENT_LABEL, "  📖  Story Teller Workflow"));
  ...
  /** Prints an informational line. */
  public static void finalResult(String text) {
    System.out.println("\n");
    System.out.println(s(FINAL_RESULT, text));
  }
