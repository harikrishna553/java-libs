...
public class EdgeOutgoingVertex {
	public static void main(String args[]) {
		...
		try (JanusGraph janusGraph = JanusGraphFactory.open("/Users/Shared/janus.properties")) {
			...
			JanusGraphVertex janusGraphVertex = janusGraphEdge.outVertex();
			System.out.println("Outgoin vertex is : " + janusGraphVertex.property("name").value());
